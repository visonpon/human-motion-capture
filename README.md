...
15. Real-time RGBD-based Extended Body Pose Estimation [[code]](https://github.com/rmbashirov/rgbd-kinect-pose)
16. EasyMocap [[code]](https://github.com/zju3dv/EasyMocap)
17. PanoMan: Sparse Localized Components–based Model for Full Human Motions [[paper]](https://dl.acm.org/doi/10.1145/3447244)
18. Monocular Total Capture: Posing Face, Body and Hands in the Wild [[code]](https://github.com/CMU-Perceptual-Computing-Lab/MonocularTotalCapture)
19. Full-body motion capture for multiple closely interacting persons [[paper]](http://cic.tju.edu.cn/faculty/likun/GM.pdf)
20. PARE: Part Attention Regressor for 3D Human Body Estimation [[project]](https://pare.is.tue.mpg.de/) | [[code]](https://github.com/mkocabas/PARE)
21. DSFN: Dynamic Surface Function Networks for Clothed Human Bodies [[code]](https://github.com/andreiburov/DSFN?utm_source=catalyzex.com)
22. 3D Human Pose and Shape Estimation Through Collaborative Learning and Multi-view Model-fitting [[code]](https://github.com/leezhongguo/MVSPIN_NEW)
23. On Self-Contact and Human Pose [[project]](https://tuch.is.tue.mpg.de/)
24. KAMA: 3D Keypoint Aware Body Mesh Articulation [[paper]](https://arxiv.org/pdf/2104.13502.pdf) | [[video]](https://www.youtube.com/watch?v=mPikZEIpUE0)
25. Bilevel Online Adaptation for Out-of-Domain Human Mesh Reconstruction [[project]](https://sites.google.com/view/humanmeshboa)
26. Multi-person Implicit Reconstruction from a Single Image [[paper]](https://openaccess.thecvf.com/content/CVPR2021/papers/Mustafa_Multi-Person_Implicit_Reconstruction_From_a_Single_Image_CVPR_2021_paper.pdf) | [[video]](https://www.youtube.com/watch?v=zElti-xPSQg)
27. Body Meshes as Points [[code]](https://github.com/jfzhang95/BMP)
28. Collaborative Regression of Expressive Bodies using Moderation [[project]](https://pixie.is.tue.mpg.de/)
29. Deep3DPose: Realtime Reconstruction of Arbitrarily Posed Human Bodies from Single RGB Images [[paper]](https://arxiv.org/pdf/2106.11536.pdf)
30. RobustFusion: Robust Volumetric Performance Reconstruction under Human-object Interactions from Monocular RGBD Stream [[paper]](https://arxiv.org/pdf/2104.14837.pdf)
31. Monocular Real-time Full Body Capture with Inter-part Correlations [[paper]](https://openaccess.thecvf.com/content/CVPR2021/papers/Zhou_Monocular_Real-Time_Full_Body_Capture_With_Inter-Part_Correlations_CVPR_2021_paper.pdf)
32. Learning Complex 3D Human Self-Contact [[pdf]](https://arxiv.org/pdf/2012.10366.pdf)
33. Learning Local Recurrent Models for Human Mesh Recovery [[pdf]](https://arxiv.org/pdf/2107.12847.pdf)
34. LASOR: Learning Accurate 3D Human Pose and Shape Via Synthetic Occlusion-Aware Data and Neural Mesh Rendering [[pdf]](https://arxiv.org/pdf/2108.00351.pdf)
35. Probabilistic Modeling for Human Mesh Recovery [[code]](https://www.seas.upenn.edu/~nkolot/projects/prohmr/)
36. Encoder-decoder with Multi-level Attention for 3D Human Shape and PoseEstimation [[code]](https://github.com/ziniuwan/maed)
37. LEMO: Learning Motion Priors for 4D Human Body Capture in 3D Scenes [[ptoject]](https://sanweiliti.github.io/LEMO/LEMO.html)
38. Shape-aware Multi-Person Pose Estimation from Multi-View Images [[project]](https://ait.ethz.ch/projects/2021/multi-human-pose/)
39. SPEC: Seeing People in the Wild with an Estimated Camera [[project]](https://github.com/mkocabas/SPEC)
40. Learning to Regress Bodies from Images using Differentiable Semantic Rendering [[code]](https://github.com/saidwivedi/DSR)
41. Mesh Graphormer [[code]](https://github.com/microsoft/MeshGraphormer)
42. VoteHMR: Occlusion-Aware Voting Network for Robust 3D Human Mesh Recovery from Partial Point Clouds [[pdf]](https://arxiv.org/pdf/2110.08729.pdf)
43. Leveraging MoCap Data for Human Mesh Recovery [[pdf]](https://arxiv.org/pdf/2110.09243.pdf)
44. PIXIE: Collaborative Regression of Expressive Bodies [[code]](https://github.com/YadiraF/PIXIE)
45. Dynamic Multi-Person Mesh Recovery From Uncalibrated Multi-View Cameras [[pdf]](https://arxiv.org/pdf/2110.10355.pdf) }| [[code]](https://github.com/boycehbz/DMMR)
46. Hierarchical Kinematic Probability Distributions for 3D Human Shape and Pose Estimation from Images in the Wild [[code]](https://github.com/akashsengupta1997/HierarchicalProbabilistic3DHuman)
47. Out-of-Domain Human Mesh Reconstruction via Dynamic Bilevel Online Adaptation [[code]](https://github.com/syguan96/dynaboa)
48. Tracking People with 3D Representations [[code]](https://brjathu.github.io/T3DP/)
49. LatentHuman: Shape-and-Pose Disentangled Latent Representation for for Human Bodies[[project]](https://latenthuman.github.io/)
50. PoseBERT [[project]](https://europe.naverlabs.com/blog/posebert/)
51. Camera Motion Agnostic 3D Human Pose Estimation [[code]](https://github.com/seonghyunkim1212/GMR)
52. GLAMR: Global Occlusion-Aware Human Mesh Recovery with Dynamic Cameras [[project]](https://www.ye-yuan.com/glamr/)
53. Revitalizing Optimization for 3D Human Pose and Shape Estimation: A Sparse Constrained Formulation [[project]](https://sites.google.com/view/scope-human/home#h.j4u4ho36ixe8)
54. ICON: Implicit Clothed humans Obtained from Normals [[code]](https://github.com/YuliangXiu/ICON)
55. Capturing Humans in Motion: Temporal-Attentive 3D Human Pose and Shape Estimation from Monocular Video [[project]](https://mps-net.github.io/MPS-Net/)
56. Occluded Human Mesh Recovery [[pdf]](https://arxiv.org/pdf/2203.13349.pdf)
57. Out-of-Domain Human Mesh Reconstruction via Dynamic Bilevel Online Adaptation [[code]](https://github.com/syguan96/DynaBOA)
